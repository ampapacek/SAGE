...
TRANSLATIONS = {
    "en": {
        ...
        "assignments_import_title": "Import Assignment ZIP",
        "assignments_import_file": "Assignment ZIP file",
        "assignments_import_hint": (
            "ZIP must contain assigment.md/txt (or assignment.md/txt). Optional: "
        ...
        "folder_count_hint": "The number shows how many assignments are in the folder.",
        "folder_move_hint": "Use the arrows to move the folder up or down.",
        ...
        "hero_chip_folders": "Folders for subjects",
    ...
    "cs": {
        ...
        "assignments_import_title": "Import úkolu ze ZIP",
        "assignments_import_file": "ZIP soubor úkolu",
        "assignments_import_hint": (
            "ZIP musí obsahovat assigment.md/txt (nebo assignment.md/txt). Volitelně: "
        ...
        "show_folder": "Zobrazit",
        "hide_folder": "Skrýt",
        "drag_hint": "Přetáhněte ikonu ruky pro přesun mezi složkami.",
        "folder_count_hint": "Cislo ukazuje pocet ukolu ve slozce.",
        "folder_move_hint": "Sipky posouvaji slozku nahoru nebo dolu.",
        ...
        "hero_chip_folders": "Složky pro předměty",
...
def create_app():
    ...
    def edit_rubric(rubric_id):
        ...
        editable_statuses = {
            ...
            RubricStatus.ERROR,
            RubricStatus.CANCELLED,
        }
        if rubric.status not in editable_statuses:
            flash("This grading guide cannot be edited while generation is running.")
            return redirect(url_for("rubric_detail", rubric_id=rubric.id))
