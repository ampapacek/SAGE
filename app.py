...
TRANSLATIONS = {
    ...
    "cs": {
        ...
        "why_sage1_text": "Používejte průvodce s bodováním po částech a jasnými srážkami.",
        "why_sage2_title": "Flexibilní formáty",
        "why_sage2_text": "Podpora PDF, obrázků i textu, včetně ZIP nahrávek pro celé třídy.",
