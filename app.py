...
TRANSLATIONS = {
    "en": {
        ...
        "traceable_output": "Structured output",
        "control_over_steps": "Control over all steps",
        "sage_home": "SAGE Home",
        ...
        "feature_traceable_text": "Export all gradings for all students in a clean CSV table.",
        "feature_control_text": "All parts of the process are editable, end to end.",
    ...
    "cs": {
        ...
        "assignments_empty_hint": "Začněte vytvořením prvního zadání níže.",
        ...
        "quick_start_cta_desc": "Vytvořte první zadání a sledujte, jak SAGE projde od nastavení ke zpětné vazbě během pár minut.",
        "quick_start_cta_button": "Začít vytvářet zadání",
        ...
        "traceable_output": "Strukturované výstupy",
        "control_over_steps": "Kontrola nad všemi kroky",
        "sage_home": "SAGE domů",
        ...
        "feature_traceable_text": "Export všech hodnocení všech studentů do přehledné tabulky CSV.",
        "feature_control_text": "Všechny části procesu jsou upravitelné od začátku do konce.",
