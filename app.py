...
TRANSLATIONS = {
    "en": {
        ...
        "assignments_empty_steps": "Next: create a grading guide, then upload submissions for automated feedback.",
    ...
    "cs": {
        ...
        "assignments_empty_steps": "Poté vytvořte hodnoticí průvodce a nahrajte odevzdání pro automatickou zpětnou vazbu.",
